...
Der Compiler erzwingt die Regel, dass `readonly`-Member Werte nicht ändern. Die folgende Methode wird nicht kompiliert, es sei denn, man entfernt den readonly-Modifizierer:
```cs
