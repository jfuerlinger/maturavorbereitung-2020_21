...
Das Propertyname bezeichnet die „Gegenseite“ und endet auf Id.
...
Das Entity wird einer Table zugeordnet mit demselben Namen so wie die entsprechende Property `DbSet<TEntity>`.
...
Das gängigste Muster für Beziehungen besteht darin, dass für beide Enden der Beziehung Navigation Properties und eine Fremdschlüssel Property definiert sind, die in der abhängigen Entitäts Klasse definiert ist.
Wenn zwischen zwei Typen ein paar Navigations Properties gefunden werden, werden diese als umgekehrte Navigation Properties derselben Beziehung konfiguriert.
Wenn die abhängige Entität eine Property mit einem Namen enthält, der mit einem dieser Muster übereinstimmt, wird Sie als Fremdschlüssel konfiguriert:
...
![](https://www.learnentityframeworkcore.com/images/17-08-2016-14-01-13.png)
...
Im Entwicklungsprozess wird bei jeder Änderung am Model die DB auf den neuesten Stand migriert.
